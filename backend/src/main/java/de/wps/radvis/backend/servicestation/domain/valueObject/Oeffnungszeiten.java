...
public class Oeffnungszeiten {
	...
	private Oeffnungszeiten(String value) {
	...
	public static Oeffnungszeiten of(String value) {
		return new Oeffnungszeiten(value);
	}

	@Override
	public String toString() {
		return String.format("Oeffnungszeiten{value='%s'}", value);
	}
}
