...
public enum SollStandard {

	STARTSTANDARD_RADNETZ("RadNETZ-Startstandard"),
	ZIELSTANDARD_RADNETZ("RadNETZ-Zielstandard"),
	BASISSTANDARD("Basisstandard"),
	RADVORRANGROUTEN("Radvorrangrouten"),
	RADSCHNELLVERBINDUNG("Radschnellverbindung"),
	KEIN_STANDARD_ERFUELLT("Kein Standard erfüllt");
