...
public class LuftpumpeUserType implements AttributeConverter<Luftpumpe, Boolean> {
	...
	@Override
	public Boolean convertToDatabaseColumn(Luftpumpe valueObject) {
		return valueObject == null ? null : valueObject.getValue();
	}

	@Override
	public Luftpumpe convertToEntityAttribute(Boolean dbData) {
		return dbData == null ? null : Luftpumpe.of(dbData);
	}
}
