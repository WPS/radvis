...
@Getter
@Builder
public class SaveZustaendigkeitAttributGruppeCommand {
	...
	private List<@Valid SaveZustaendigkeitAttributeCommand> zustaendigkeitAttribute;

	@AssertTrue(message = "Zustaendigkeit fehlerhaft: " + SEGMENTS_MUST_COVER_FULL_LINE_MSG)
	public boolean isSegementsCoverFullLineTrue() {
		return LinearReferenzierterAbschnitt.segmentsCoverFullLine(
			zustaendigkeitAttribute.stream()
				.map(SaveZustaendigkeitAttributeCommand::getLinearReferenzierterAbschnitt)
