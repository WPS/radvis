...
public interface CustomImportedFeaturePersistentRepository {

	List<ImportedFeatureMapView> getFeaturesInBereich(QuellSystem quelle, Art art, Envelope bereich);
