...
public class RadNetzFreizeitEncodedValue extends AbstractNetzklasseEncodedValue {
	...
	public static String getOsmKey() {
		return "radvis:netzklasse:radnetz_freizeit";
	}

	public static String getEncodedValueKey() {
		return "netzklasse_radnetz_freizeit";
	}
