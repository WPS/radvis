...
public interface KantenWithInitialStatesRepository extends CrudRepository<KanteWithInitialStatesView, Long> {
	public Stream<KanteWithInitialStatesView> findByStatusNot(Status status);
}
