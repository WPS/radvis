...
public class RadverkehrsfuehrungEncodedValue extends AbstractStringEncodedValue {
	public static StringEncodedValue create() {
		List<String> allItems = Arrays.stream(Radverkehrsfuehrung.values()).map(Enum::name).toList();
