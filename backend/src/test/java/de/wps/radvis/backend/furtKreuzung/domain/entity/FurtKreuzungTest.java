...
class FurtKreuzungTest {
	...
	void ersetzeKnotenInNetzbezug() {
		...
		furtKreuzung.ersetzeKnotenInNetzbezug(ersatzKnotenZuordnung);

		// assert
		assertThat(furtKreuzung.getNetzbezug().getImmutableKnotenBezug()).contains(knoten2, ersatzKnoten);
		assertThat(furtKreuzung.getNetzbezug().getImmutableKnotenBezug()).doesNotContain(zuErsetzenderKnoten);
	}
}
