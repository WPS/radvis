...
public class KommunalnetzAlltagEncodedValue extends AbstractNetzklasseEncodedValue {
	...
	public static String getOsmKey() {
		return "radvis:netzklasse:kommunalnetz_alltag";
	}

	public static String getEncodedValueKey() {
		return "netzklasse_kommunalnetz_alltag";
	}
