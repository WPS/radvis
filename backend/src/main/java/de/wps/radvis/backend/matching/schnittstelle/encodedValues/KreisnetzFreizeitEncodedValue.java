...
public class KreisnetzFreizeitEncodedValue extends AbstractNetzklasseEncodedValue {
	...
	public static String getOsmKey() {
		return "radvis:netzklasse:kreisnetz_freizeit";
	}

	public static String getEncodedValueKey() {
		return "netzklasse_kreisnetz_freizeit";
	}
