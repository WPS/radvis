...
@NoArgsConstructor
@Getter
public class MassnahmeNetzBezugAenderung extends NetzBezugAenderung implements FehlerprotokollEintrag {

	@OneToOne(optional = false)
	private Massnahme massnahme;

	public MassnahmeNetzBezugAenderung(NetzBezugAenderungsArt netzBezugAenderungsArt, Long kantenKnotenId,
		Massnahme massnahme, Benutzer technischerBenutzer, LocalDateTime datum, NetzAenderungAusloeser ausloeser,
		Geometry geometry) {
	...
	public String getTitel() {
		return "Netzbezug-Änderung (Maßnahme)";
	}

	@Override
	public String getEntityLink() {
		return FrontendLinks.massnahmeDetailView(massnahme.getId());
	}
}
