...
export interface GeschwindigkeitAttribute extends LinearReferenzierteAttribute {
  ortslage: KantenOrtslage | null;
  hoechstgeschwindigkeit: Hoechstgeschwindigkeit;
  abweichendeHoechstgeschwindigkeitGegenStationierungsrichtung: Hoechstgeschwindigkeit | null;
}
