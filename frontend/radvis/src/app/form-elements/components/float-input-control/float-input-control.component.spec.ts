...
import { FloatInputControlComponent } from './float-input-control.component';

describe(FloatInputControlComponent.name, () => {
  let component: FloatInputControlComponent;
  let fixture: ComponentFixture<FloatInputControlComponent>;

  beforeEach(() => {
    return MockBuilder(FloatInputControlComponent, EditorModule);
  });

  beforeEach(() => {
    fixture = MockRender(FloatInputControlComponent);
