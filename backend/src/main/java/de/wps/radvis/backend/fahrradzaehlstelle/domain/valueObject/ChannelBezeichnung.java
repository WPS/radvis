...
@ToString
@EqualsAndHashCode
public class ChannelBezeichnung {
	...
	private ChannelBezeichnung(String value) {
	...
	public static ChannelBezeichnung of(String value) {
		return new ChannelBezeichnung(value);
	}
}
