...
public class FahrradhalterungUserType implements AttributeConverter<Fahrradhalterung, Boolean> {
	...
	@Override
	public Boolean convertToDatabaseColumn(Fahrradhalterung valueObject) {
		return valueObject == null ? null : valueObject.getValue();
	}

	@Override
	public Fahrradhalterung convertToEntityAttribute(Boolean dbData) {
		return dbData == null ? null : Fahrradhalterung.of(dbData);
	}
}
