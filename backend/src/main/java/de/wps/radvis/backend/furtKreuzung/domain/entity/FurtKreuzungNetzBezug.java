...
public class FurtKreuzungNetzBezug extends AbstractNetzBezug {
	...
	public FurtKreuzungNetzBezug withKanteErsetzt(Kante zuErsetzendeKante, Set<Kante> zuErsetzenDurch,
		double erlaubteAbweichung) {
		require(zuErsetzenDurch, notNullValue());
		require(!zuErsetzenDurch.isEmpty());

		return new FurtKreuzungNetzBezug(
	...
	public FurtKreuzungNetzBezug withoutKanten(Set<Long> kantenIds) {
		FurtKreuzungNetzBezug result = new FurtKreuzungNetzBezug();
	...
	public FurtKreuzungNetzBezug withoutKnoten(Set<Long> knotenIds) {
		FurtKreuzungNetzBezug result = new FurtKreuzungNetzBezug();
	...
	public FurtKreuzungNetzBezug withKnotenErsetzt(Map<Long, Knoten> ersatzKnoten) {
		return new FurtKreuzungNetzBezug(getImmutableKantenAbschnittBezug(), getImmutableKantenPunktBezug(),
