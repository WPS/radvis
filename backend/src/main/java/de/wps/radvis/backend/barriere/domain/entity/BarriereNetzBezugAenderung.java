...
@NoArgsConstructor
@Getter
public class BarriereNetzBezugAenderung extends NetzBezugAenderung implements FehlerprotokollEintrag {

	@OneToOne(optional = false)
	private Barriere barriere;

	public BarriereNetzBezugAenderung(NetzBezugAenderungsArt netzBezugAenderungsArt, Long kantenKnotenId,
		Barriere barriere, Benutzer technischerBenutzer, LocalDateTime datum, NetzAenderungAusloeser ausloeser,
		Geometry geometry) {
	...
	public String getTitel() {
		return "Netzbezug-Änderung (Barriere)";
	}

	@Override
	public String getEntityLink() {
		return FrontendLinks.barriereDetailView(barriere.getId());
	}
}
