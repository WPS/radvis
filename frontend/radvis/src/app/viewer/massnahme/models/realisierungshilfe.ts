        ...
        switch (k) {
          ...
          case Realisierungshilfe.RSV_H_4:
            return {
              name: k,
              displayText:
                'RSV - H 4 Bevorrechtigte Führung auf baulichen Radwegen im Zweirichtungsverkehr - außerorts',
            };
          ...
          case Realisierungshilfe.RSV_N_2:
            return {
              name: k,
              displayText:
                'RSV - N 2 Fahrradstraße innerhalb von Tempo-30-Zonen (Bauliche Bevorrechtigung) - innerorts',
            };
