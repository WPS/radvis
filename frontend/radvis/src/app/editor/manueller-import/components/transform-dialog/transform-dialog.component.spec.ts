...
describe(TransformDialogComponent.name, () => {
  let component: TransformDialogComponent;
  let fixture: ComponentFixture<TransformDialogComponent>;
  ...
  beforeEach(
    waitForAsync(() => {
      fixture = TestBed.createComponent(TransformDialogComponent);
      component = fixture.componentInstance;
      fixture.detectChanges();
    })
  );

  describe(TransformDialogComponent.prototype.openManualEditorTransformation.name, () => {
    beforeEach(() => {
