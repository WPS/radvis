...
class KommunalLueckeKonsistenzregelTestIT extends AbstractKonsistenzregelTestIT {
	...
	void pruefen() {
		...
		List<KonsistenzregelVerletzungsDetails> verletzungsDetails = kommunalnetzLueckeKonsistenzregel.pruefen();
