...
export interface MassnahmenDateianhaengeZuordnung {
  ordnername: string;
...
export interface MassnahmenDateianhaengeMappingHinweis {
  text: string;
  severity: MassnahmenDateianhaengeImportMappingSeverity;
}

export enum MassnahmenDateianhaengeImportMappingSeverity {
  ERROR = 'ERROR',
  WARN = 'WARN',
}
