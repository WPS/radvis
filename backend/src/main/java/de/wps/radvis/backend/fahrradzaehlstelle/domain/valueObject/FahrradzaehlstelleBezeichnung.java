...
@ToString
@EqualsAndHashCode
public class FahrradzaehlstelleBezeichnung {
	...
	private FahrradzaehlstelleBezeichnung(String value) {
	...
	public static FahrradzaehlstelleBezeichnung of(String value) {
		return new FahrradzaehlstelleBezeichnung(value);
	}
