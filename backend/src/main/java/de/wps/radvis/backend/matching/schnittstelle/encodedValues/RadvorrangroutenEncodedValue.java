...
public class RadvorrangroutenEncodedValue extends AbstractNetzklasseEncodedValue {
	...
	public static String getOsmKey() {
		return "radvis:netzklasse:radvorrangrouten";
	}

	public static String getEncodedValueKey() {
		return "netzklasse_radvorrangrouten";
	}
