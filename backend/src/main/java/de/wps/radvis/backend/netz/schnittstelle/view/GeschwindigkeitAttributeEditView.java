...
@AllArgsConstructor
@NoArgsConstructor
public class GeschwindigkeitAttributeEditView {
	...
	public GeschwindigkeitAttributeEditView(GeschwindigkeitAttribute geschwindigkeitAttribute) {

		this.ortslage = geschwindigkeitAttribute.getOrtslage().orElse(null);
		this.hoechstgeschwindigkeit = geschwindigkeitAttribute.getHoechstgeschwindigkeit();
		this.abweichendeHoechstgeschwindigkeitGegenStationierungsrichtung = geschwindigkeitAttribute
			.getAbweichendeHoechstgeschwindigkeitGegenStationierungsrichtung()
			.orElse(null);

		this.linearReferenzierterAbschnitt = geschwindigkeitAttribute.getLinearReferenzierterAbschnitt();
	}
}
