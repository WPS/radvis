...
@Getter
public abstract class AbstractOrganisationImportSessionView extends AbstractImportSessionView {
	...
	protected AbstractOrganisationImportSessionView(AbstractImportSession abstractImportSession,
		Verwaltungseinheit organisation) {
		super(abstractImportSession);
		this.aktuellerImportSchritt = abstractImportSession.getAktuellerImportSchritt();
		this.organisationsID = organisation.getId();
