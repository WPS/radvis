...
export class FeatureTogglzService {
  ...
  public static readonly TOGGLZ_ORGANISATIONEN_ERSTELLEN_UND_BEARBEITEN = 'ORGANISATIONEN_ERSTELLEN_UND_BEARBEITEN';
  ...
  public static readonly TOGGLZ_DEFAULT_VERSIONSINFO_DIALOG = 'DEFAULT_VERSIONSINFO_DIALOG';
