...
public class KreisnetzAlltagEncodedValue extends AbstractNetzklasseEncodedValue {
	...
	public static String getOsmKey() {
		return "radvis:netzklasse:kreisnetz_alltag";
	}

	public static String getEncodedValueKey() {
		return "netzklasse_kreisnetz_alltag";
	}
