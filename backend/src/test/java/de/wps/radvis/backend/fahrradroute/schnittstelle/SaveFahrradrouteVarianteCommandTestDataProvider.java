...
public class SaveFahrradrouteVarianteCommandTestDataProvider {

	public static SaveFahrradrouteVarianteCommand.SaveFahrradrouteVarianteCommandBuilder withDefaultValue() {
		return SaveFahrradrouteVarianteCommand.builder()
