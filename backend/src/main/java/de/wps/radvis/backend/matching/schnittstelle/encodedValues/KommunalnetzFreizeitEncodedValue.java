...
public class KommunalnetzFreizeitEncodedValue extends AbstractNetzklasseEncodedValue {
	public static SimpleBooleanEncodedValue create() {
		return new SimpleBooleanEncodedValue(getEncodedValueKey());
	}

	public static String getOsmKey() {
		return "radvis:netzklasse:kommunalnetz_freizeit";
	}

	public static String getEncodedValueKey() {
		return "netzklasse_kommunalnetz_freizeit";
	}
