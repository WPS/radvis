...
public enum Rolle {
	RADVIS_ADMINISTRATOR(
		"RadVIS AdministratorIn",
		Recht.JOBS_AUSFUEHREN,
		Recht.LOGS_EINSEHEN,
		Recht.FACHLICHE_STATISTIKEN_EINSEHEN,
		...
		Recht.ALLE_RADVIS_KANTEN_LOESCHEN,
		Recht.ALLE_ROLLEN,
		...
		Recht.UMSETZUNGSSTANDSABFRAGEN_STARTEN,
		...
		Recht.DATEI_LAYER_VERWALTEN,
		Recht.WEITERE_KARTENEBENEN_ALS_DEFAULT_FESTLEGEN,
		Recht.ROUTINGPROFILE_VERWALTEN,
		Recht.SYSTEMNACHRICHT_ERSTELLEN),
	...
	RADWEGE_ERFASSERIN(
		"Radwege ErfasserIn - Kommune/Kreis/Regierungsbezirk",
		Recht.EIGENEN_BEREICH_EINER_ORGANISATION_ZUORDNEN,
		Recht.BEARBEITUNG_VON_RADWEGSTRECKEN_DES_EIGENEN_GEOGRAPHISCHEN_ZUSTAENDIGKEIT,
		Recht.MASSNAHME_IM_ZUSTAENDIGKEITSBEREICH_ERFASSEN_BEARBEITEN_VEROEFFENTLICHEN,
		Recht.RADROUTEN_IM_ZUSTAENDIGKEITSBEREICH_ERFASSEN_BEARBEITEN,
	...
	RADVERKEHRSBEAUFTRAGTER(
		"RadverkehrsbeauftragteR Regierungsbezirk",
		Recht.BENUTZER_UND_ORGANISATIONEN_MEINES_VERWALTUNGSBEREICHS_BEARBEITEN,
		Recht.EIGENEN_BEREICH_EINER_ORGANISATION_ZUORDNEN,
		Recht.RADNETZ_ROUTENVERLEGUNGEN,
		Recht.BEARBEITUNG_VON_RADWEGSTRECKEN_DES_EIGENEN_GEOGRAPHISCHEN_ZUSTAENDIGKEIT,
	...
	BEARBEITERIN_VM_RADNETZ_ADMINISTRATORIN(
		"BearbeiterIn (VM)/RadNETZ-AdministratorIn",
		Recht.RADNETZ_ROUTENVERLEGUNGEN,
		Recht.BEARBEITUNG_VON_RADWEGSTRECKEN_DES_EIGENEN_GEOGRAPHISCHEN_ZUSTAENDIGKEIT,
		Recht.MASSNAHME_IM_ZUSTAENDIGKEITSBEREICH_ERFASSEN_BEARBEITEN_VEROEFFENTLICHEN,
		Recht.MASSNAHMEN_STORNIEREN,
	...
	RADNETZ_QUALITAETSSICHERIN(
		"RadNETZ-QualitätssicherIn",
		Recht.MASSNAHME_IM_ZUSTAENDIGKEITSBEREICH_ERFASSEN_BEARBEITEN_VEROEFFENTLICHEN,
		Recht.RADROUTEN_IM_ZUSTAENDIGKEITSBEREICH_ERFASSEN_BEARBEITEN,
		Recht.BARRIEREN_IM_ZUSTAENDIGKEITSBEREICH_ERFASSEN_BEARBEITEN,
		Recht.SERVICEANGEBOTE_IM_ZUSTAENDIGKEITSBEREICH_ERFASSEN_BEARBEITEN,
	...
	RADROUTEN_BEARBEITERIN(
		"RadroutenbearbeiterIn",
