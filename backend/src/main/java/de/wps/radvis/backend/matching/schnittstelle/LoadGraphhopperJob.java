...
@Slf4j
public class LoadGraphhopperJob extends AbstractJob {
	private final DlmMatchedGraphHopperFactory dlmMatchedGraphHopperFactory;

	public LoadGraphhopperJob(JobExecutionDescriptionRepository repository,
