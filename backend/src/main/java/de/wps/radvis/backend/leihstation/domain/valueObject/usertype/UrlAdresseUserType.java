...
public class UrlAdresseUserType implements AttributeConverter<UrlAdresse, String> {
	...
	@Override
	public String convertToDatabaseColumn(UrlAdresse urlAdresse) {
		return urlAdresse == null ? null : urlAdresse.getValue();
	}

	@Override
	public UrlAdresse convertToEntityAttribute(String dbData) {
		return dbData == null ? null : UrlAdresse.of(dbData);
	}
}
