...
export enum AbstellanlagenQuellSystem {
  RADVIS = 'RADVIS',
...
export namespace AbstellanlagenQuellSystem {
  ...
  export const getDisplayText: (abstellanlagenQuellSystem: AbstellanlagenQuellSystem) => string = (
    ...
    const enumOption = options.find(({ name }) => name === abstellanlagenQuellSystem);
    invariant(enumOption, `AbstellanlagenQuellSystem.${abstellanlagenQuellSystem} hat keine EnumOption`);
