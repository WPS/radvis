...
public class RadNetzZielnetzEncodedValue extends AbstractNetzklasseEncodedValue {
	...
	public static String getOsmKey() {
		return "radvis:netzklasse:radnetz_zielnetz";
	}

	public static String getEncodedValueKey() {
		return "netzklasse_radnetz_zielnetz";
	}
