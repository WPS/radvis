...
package de.wps.radvis.backend.kommentar.domain.entity.provider;
...
public class KommentarTestDataProvider {
	public static Kommentar.KommentarBuilder withDefaultValues() {
		...
		return Kommentar.privateBuilder()
			.kommentarText("Default Kommentar")
			.benutzer(benutzer)
