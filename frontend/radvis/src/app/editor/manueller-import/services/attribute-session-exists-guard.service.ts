...
export class AttributeSessionExistsGuard implements CanActivate {
  constructor(
  ...
  canActivate(): Observable<boolean | UrlTree> | Promise<boolean | UrlTree> | boolean | UrlTree {
    return this.manuellerImportService.existsImportSession(ImportTyp.ATTRIBUTE_UEBERNEHMEN).then(exists => {
      if (!exists) {
