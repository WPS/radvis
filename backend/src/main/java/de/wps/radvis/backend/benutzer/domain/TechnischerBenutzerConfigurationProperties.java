...
@ConfigurationProperties("radvis.technischerbenutzer")
public class TechnischerBenutzerConfigurationProperties {
	...
	@Getter
	private final String serviceBwId;

	@Getter
	private final String mailAdresse;

	@ConstructorBinding
	public TechnischerBenutzerConfigurationProperties(
		String name,
		String vorname,
		String serviceBwId,
		String mailadresse) {
