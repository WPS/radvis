...
@Getter
public class AttributeImportSessionView extends AbstractImportSessionView {
	...
	public AttributeImportSessionView(AttributeImportSession attributeImportSession) {
		super(attributeImportSession, ImportTyp.ATTRIBUTE_UEBERNEHMEN);
		this.attribute = attributeImportSession.getAttribute();
		this.anzahlKantenMitUneindeutigerAttributzuordnung = attributeImportSession.getAnzahlKantenMitUneindeutigerAttributzuordnung();
