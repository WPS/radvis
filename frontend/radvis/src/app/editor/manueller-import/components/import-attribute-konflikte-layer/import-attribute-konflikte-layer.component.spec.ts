...
describe('ImportAttributeKonflikteLayerComponent', () => {
  ...
  beforeEach(fakeAsync(() => {
    ...
    when(manuellerImportService.getKonfliktprotokolle()).thenReturn(
      Promise.resolve(createDummyKonflikteFeatureCollection())
    );
    component = new ImportAttributeKonflikteLayerComponent(instance(olMapService), instance(manuellerImportService));
    tick();
  }));
