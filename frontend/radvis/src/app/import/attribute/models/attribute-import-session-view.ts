...
export interface AttributeImportSessionView extends ImportSessionView {
  aktuellerImportSchritt: AutomatischerImportSchritt;
  organisationsID: number;
  anzahlFeaturesOhneMatch: number | null;
  attribute: string[];
  anzahlKantenMitUneindeutigerAttributzuordnung: number | null;
  attributeImportFormat: AttributeImportFormat;
}
