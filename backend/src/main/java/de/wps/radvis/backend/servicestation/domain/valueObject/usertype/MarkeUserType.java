...
public class MarkeUserType implements AttributeConverter<Marke, String> {
	...
	@Override
	public String convertToDatabaseColumn(Marke marke) {
		return marke == null ? null : marke.getValue();
	}

	@Override
	public Marke convertToEntityAttribute(String dbData) {
		return dbData == null ? null : Marke.of(dbData);
	}
}
