...
export interface FahrradzaehlstelleDetailView {
  id: number;
  geometrie: PointGeojson;
  betreiberEigeneId: string;
  fahrradzaehlstelleGebietskoerperschaft: string;
  fahrradzaehlstelleBezeichnung: string;
  seriennummer: string;
  zaehlintervall: string;
  neusterZeitstempel: string;
