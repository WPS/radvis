...
public class GeoserverDatastoreName {
	...
	private GeoserverDatastoreName(@NonNull String value) {
		require(isValid(value),
			"Geoserver Datastore-Name muss mindestens eins und darf maximal 255 Zeichen haben. Nur die Zeichen a-z, 0-9 '-' und '_' sind erlaubt.");
		this.value = value;
	}

	@JsonCreator(mode = JsonCreator.Mode.DELEGATING)
	public static GeoserverDatastoreName of(String value) {
		return new GeoserverDatastoreName(value);
	}

	public static GeoserverDatastoreName withTimestamp(String value) {
	...
	public static String normalizeGeoserverName(String name) {
		return name
			.toLowerCase()
			.replace(" ", "_")
			.replace("ä", "ae")
