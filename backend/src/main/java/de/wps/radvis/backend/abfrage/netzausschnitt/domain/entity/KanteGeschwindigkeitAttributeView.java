...
@Entity
@Table(name = "kante_geschwindigkeit_linearreferenzierteattribute_view")
public class KanteGeschwindigkeitAttributeView extends AbstractKanteLinearReferenzierteAttributeView {

	private static final long serialVersionUID = -7534396689923679077L;
