...
public class Werkzeug extends AbstractBooleanVO {

	private Werkzeug(Boolean value) {
		super(value);
	}

	private Werkzeug(String value) {
		super(value);
	}

	@JsonCreator(mode = JsonCreator.Mode.DELEGATING)
	public static Werkzeug of(Boolean value) {
	...
	public String toString() {
		return String.format("Werkzeug{value='%s'}", value);
	}
}