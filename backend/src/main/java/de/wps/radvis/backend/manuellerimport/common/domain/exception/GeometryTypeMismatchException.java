...
public class GeometryTypeMismatchException extends Exception {
	...
	public GeometryTypeMismatchException(SimpleFeature f) {
		super("Feature mit ID " + f.getID()
			+ " hat falschen Geometrie-Typ, erlaubt ist LineString oder MultiLinestring mit einem Eintrag");
	}
}
