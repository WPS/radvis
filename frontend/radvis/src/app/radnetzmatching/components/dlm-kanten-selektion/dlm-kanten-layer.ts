...
@Injectable()
export class DlmKantenLayer extends RadVisLayer {
  public static LAYER_ID = 'DLM';
  public static LAYER_NAME = 'DLM-Kanten';

  constructor() {
    const defaultColor: Color = MapStyles.FEATURE_COLOR as Color;
    const lightBlue = [163, 188, 214, 1];
    const defaultPointLargeStyle = new Style({
      image: MapStyles.circleWithFill(4, lightBlue),
    });
    ...
    super(
      DlmKantenLayer.LAYER_ID,
      DlmKantenLayer.LAYER_NAME,
      `${NetzausschnittService.BASE_URL}/kantenDLM`,
