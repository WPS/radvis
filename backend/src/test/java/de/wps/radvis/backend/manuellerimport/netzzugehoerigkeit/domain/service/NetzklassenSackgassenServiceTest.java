...
class NetzklassenSackgassenServiceTest {
	...
	void setUp() {
		...
		this.netzklassenSackgassenService = new NetzklassenSackgassenService(netzService, kantenRepository);
	}
	...
	public void teste_bestimmeSackgassenVonRadnetzKanten_endenEinerStreckeSindSackgassen() {
		...
		Kante kante1 = KanteTestDataProvider.fromKnotenUndQuelle(knoten1, knoten2, QuellSystem.DLM).build();
		Kante kante2 = KanteTestDataProvider.fromKnotenUndQuelle(knoten2, knoten3, QuellSystem.RadVis).build();
		...
		Set<Knoten> sackgassen = this.netzklassenSackgassenService.bestimmeSackgassenknotenVonKantenFuerNetzklasse(
	...
	public void teste_bestimmeSackgassenVonRadnetzKanten_kreisHatKeineSackgassen() {
		...
		Kante kante1 = KanteTestDataProvider.fromKnotenUndQuelle(knoten1, knoten2, QuellSystem.DLM).build();
		Kante kante2 = KanteTestDataProvider.fromKnotenUndQuelle(knoten2, knoten3, QuellSystem.RadVis).build();
		Kante kante3 = KanteTestDataProvider.fromKnotenUndQuelle(knoten3, knoten1, QuellSystem.RadVis).build();
	...
	public void teste_bestimmeSackgassenVonRadnetzKanten_verzweigtesBeispiel() {
		...
		Kante kante2 = KanteTestDataProvider.fromKnotenUndQuelle(knoten2, knoten3, QuellSystem.RadVis).build();
		Kante kante3 = KanteTestDataProvider.fromKnotenUndQuelle(knoten3, knoten1, QuellSystem.RadVis).build();
		Kante kante4 = KanteTestDataProvider.fromKnotenUndQuelle(knoten3, knoten4, QuellSystem.RadVis).build();
		Kante kante5 = KanteTestDataProvider.fromKnotenUndQuelle(knoten4, knoten2, QuellSystem.RadVis).build();
		Kante kante6 = KanteTestDataProvider.fromKnotenUndQuelle(knoten4, knoten1, QuellSystem.DLM).build();
		Kante kante7 = KanteTestDataProvider.fromKnotenUndQuelle(knoten5, knoten6, QuellSystem.RadVis).build();
	...
	public void teste_bestimmeSackgassenVonRadnetzKanten_geradeLinieMitLuecke() {
		...
		Kante kante1 = KanteTestDataProvider.fromKnotenUndQuelle(knoten1, knoten2, QuellSystem.DLM).build();
		Kante kante2 = KanteTestDataProvider.fromKnotenUndQuelle(knoten2, knoten3, QuellSystem.RadVis).build();
		Kante kante4 = KanteTestDataProvider.fromKnotenUndQuelle(knoten4, knoten5, QuellSystem.RadVis).build();
		Kante kante5 = KanteTestDataProvider.fromKnotenUndQuelle(knoten5, knoten6, QuellSystem.RadVis).build();
	...
	public void teste_bestimmeSackgassenknotenVonKanteIdsInOrganisation_EineKanteZweiKnotenImBereich_ZweiSackgassenKnoten() {
		...
		// act
		Set<Knoten> sackgassenKnoten = netzklassenSackgassenService.bestimmeSackgassenknotenVonKanteIdsInOrganisation(
