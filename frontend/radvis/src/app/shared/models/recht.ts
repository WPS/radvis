...
export enum Recht {
  ...
  UMSETZUNGSSTANDSABFRAGEN_VERWALTEN = 'UMSETZUNGSSTANDSABFRAGEN_VERWALTEN',
  ...
  export const options: EnumOption[] = Object.keys(Recht).map(
    (k: string): EnumOption => {
      switch (k) {
        ...
        case Recht.UMSETZUNGSSTANDSABFRAGEN_VERWALTEN:
          return { name: k, displayText: 'Umsetzungsstandsabfragen verwalten' };
