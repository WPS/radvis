...
@Getter
public class FahrradzaehlstelleDetailView {
	...
	private final List<ChannelDetailView> channels;

	public FahrradzaehlstelleDetailView(Fahrradzaehlstelle fahrradzaehlstelle) {
		...
		this.channels = fahrradzaehlstelle.getChannels().stream()
			.map(ChannelDetailView::new)
