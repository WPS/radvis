...
import de.wps.radvis.backend.integration.dlm.domain.entity.AbstractDLMImportStatistik;
...
public class CreateKantenServiceTest {
	...
	void testeCreateNewDLMKante_NichtUnterstuetzterGeometrieTyp() {
		...
		// act
		createKantenService.createNewDLMKante(importedFeature, mock(AbstractDLMImportStatistik.class), null);
