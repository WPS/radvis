...
public class WahlkreisService {

	private final WahlkreisRepository wahlkreisRepository;

	public WahlkreisService(WahlkreisRepository wahlkreisRepository) {
		this.wahlkreisRepository = wahlkreisRepository;
	}

	public List<WahlkreisView> getWahlkreise() {
		return wahlkreisRepository.findAllAsView();
	}
}
