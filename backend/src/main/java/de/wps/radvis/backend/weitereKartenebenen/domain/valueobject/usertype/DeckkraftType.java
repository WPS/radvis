...
public class DeckkraftType implements AttributeConverter<Deckkraft, Double> {
	...
	@Override
	public Double convertToDatabaseColumn(Deckkraft deckkraft) {
		return deckkraft == null ? null : deckkraft.getValue();
	}

	@Override
	public Deckkraft convertToEntityAttribute(Double dbData) {
		return dbData == null ? null : Deckkraft.of(dbData);
	}
}
