...
export class LeihstationRoutingService extends AbstractInfrastrukturenRoutingService {
  public static CREATOR_ROUTE = 'new';

  constructor(router: Router) {
    super(router, LEIHSTATIONEN);
  }

  public toCreator(): void {
    this.router.navigate([VIEWER_ROUTE, LEIHSTATIONEN.pathElement, LeihstationRoutingService.CREATOR_ROUTE], {
