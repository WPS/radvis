...
@Builder
@Getter
public class SaveGeschwindigkeitAttributGruppeCommand {
	...
	private List<@Valid SaveGeschwindigkeitAttributeCommand> geschwindigkeitAttribute;

	@AssertTrue(message = "Geschwindigkeit fehlerhaft: " + SEGMENTS_MUST_COVER_FULL_LINE_MSG)
	public boolean isSegementsCoverFullLineTrue() {
		return LinearReferenzierterAbschnitt.segmentsCoverFullLine(
			geschwindigkeitAttribute.stream()
				.map(SaveGeschwindigkeitAttributeCommand::getLinearReferenzierterAbschnitt)
