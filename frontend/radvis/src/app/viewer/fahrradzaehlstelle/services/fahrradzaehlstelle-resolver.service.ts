...
export class FahrrradzaehlstelleResolverService {
  constructor(private fahrradzaehlstelleService: FahrradzaehlstelleService) {}

  resolve(route: ActivatedRouteSnapshot): Promise<FahrradzaehlstelleDetailView> {
    const id = route.paramMap.get('id');
    if (id) {
      return this.fahrradzaehlstelleService.getFahrradzaehlstelleForView(+id);
    }
