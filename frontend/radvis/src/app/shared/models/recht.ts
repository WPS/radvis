...
export enum Recht {
  ...
  MASSNAHMEN_STORNIEREN = 'MASSNAHMEN_STORNIEREN',
...
export namespace Recht {
  export const options: EnumOption[] = Object.keys(Recht).map((k: string): EnumOption => {
    switch (k) {
      ...
      case Recht.MASSNAHMEN_STORNIEREN:
        return { name: k, displayText: 'Maßnahmen stornieren' };
    }
