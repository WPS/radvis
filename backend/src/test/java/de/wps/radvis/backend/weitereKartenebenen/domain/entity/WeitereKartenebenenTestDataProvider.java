...
public class WeitereKartenebenenTestDataProvider {
	public static WeitereKartenebene.WeitereKartenebeneBuilder defaultValue() {
		return WeitereKartenebene.builder()
