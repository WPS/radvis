...
public class KommunalNetzLueckeKonsistenzregel extends AbstractNetzklassenLueckeKonsistenzregel {
	...
	public String getTitel() {
		return "Kommunalnetz-Lücke";
	}

	@Override
	protected Set<Netzklasse> getNetzklassen() {
		return Set.of(Netzklasse.KOMMUNALNETZ_ALLTAG, Netzklasse.KOMMUNALNETZ_FREIZEIT);
	}

	@Override
	protected String getBeschreibung() {
		return "Das Kommunalnetz enthält an dieser Stelle eine Lücke bzw. eine Sackgasse.";
	}
}
