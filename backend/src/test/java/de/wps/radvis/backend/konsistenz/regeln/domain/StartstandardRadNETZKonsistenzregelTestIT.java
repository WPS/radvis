...
class StartstandardRadNETZKonsistenzregelTestIT extends AbstractKonsistenzregelTestIT {
	...
	StartstandardRadNETZKonsistenzregel startstandardRadNETZKonsistenzregel;

	@BeforeEach
	void setUp() {
		startstandardRadNETZKonsistenzregel = new StartstandardRadNETZKonsistenzregel(jdbcTemplate);
	}
	...
	void pruefen() {
		...
		Kante freizeit = kantenRepository.save(
		...
		Kante tempo30_50 = kantenRepository.save(
			KanteTestDataProvider.fromKnotenUndQuelle(knoten3, knoten4, QuellSystem.DLM)
				.kantenAttributGruppe(
					KantenAttributGruppeTestDataProvider.defaultValue()
						.netzklassen(Set.of(Netzklasse.RADNETZ_ZIELNETZ))
						.istStandards(Set.of(IstStandard.STARTSTANDARD_RADNETZ))
						.kantenAttribute(
		...
		assertThat(verletzungsDetails).containsExactlyInAnyOrder(
			new KonsistenzregelVerletzungsDetails(freizeit.getGeometry().getCentroid(), freizeit.getGeometry(),
				"Verletzung der Konsistenzregel: “Startstandard: Wenn Strecke Landesradfernweg und Mischverkehr innerorts”",
				freizeit.getId() + "_0-1"),
			new KonsistenzregelVerletzungsDetails(tempoGroesser50.getGeometry().getCentroid(),
				tempoGroesser50.getGeometry(),
				"Verletzung der Konsistenzregel: “Startstandard: Wenn Strecke RadNETZ und Mischverkehr innerorts: Tempo <= 50“",
			...
			new KonsistenzregelVerletzungsDetails(tempo30_50.getGeometry().getCentroid(), tempo30_50.getGeometry(),
				"Verletzung der Konsistenzregel: “Startstandard: Wenn Strecke RadNETZ und Mischverkehr innerorts und Tempo > 30 und Tempo <= 50: DTV <= 5000 Fz/Tag und SV <= 500 Fz/Tag“",
				tempo30_50.getId() + "_0-1"),
			new KonsistenzregelVerletzungsDetails(tempo20_30.getGeometry().getCentroid(), tempo20_30.getGeometry(),
				"Verletzung der Konsistenzregel: “Startstandard: Wenn Strecke RadNETZ und Mischverkehr innerorts und Tempo > 20 und Tempo <= 30: DTV <= 10.000 Fz/Tag und SV <= 800 Fz/Tag“",
			...
			new KonsistenzregelVerletzungsDetails(tempoKleiner20.getGeometry().getCentroid(),
				...
				"Verletzung der Konsistenzregel: “Startstandard: Wenn Strecke RadNETZ und Mischverkehr innerorts und Tempo <= 20: DTV <= 12.000 Fz/Tag und SV <= 1.000 Fz/Tag“",
