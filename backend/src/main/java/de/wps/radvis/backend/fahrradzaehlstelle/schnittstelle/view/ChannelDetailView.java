...
public class ChannelDetailView {
	...
	private final ChannelBezeichnung channelBezeichnung;
	private final Long id;

	public ChannelDetailView(Channel channel) {
		this.id = channel.getId();
		this.channelId = channel.getChannelId();
		this.channelBezeichnung = channel.getChannelBezeichnung().orElse(null);
	}
}
