...
public abstract class ProtokollService {
	private NetzfehlerRepository netzfehlerRepository;

	public ProtokollService(NetzfehlerRepository netzfehlerRepository) {
		this.netzfehlerRepository = netzfehlerRepository;
	}

	protected void protokolliere(Netzfehler netzfehler) {
