...
} from 'src/app/editor/manueller-import/components/import-attribute-layer/import-attribute-layer.component';
import { MappedGrundnetzkante } from 'src/app/editor/manueller-import/models/mapped-grundnetzkante';
...
describe(ImportAttributeLayerComponent.name, () => {
  ...
  beforeEach(() => {
    ...
    component = new ImportAttributeLayerComponent(instance(olMapService), instance(manuellerImportService));
  });
    ...
    describe('with mapClickedSubject', () => {
      ...
      describe('with modifyEnd event', () => {
        ...
        beforeEach(done => {
          ...
          when(manuellerImportService.updateMappedGrundnetzkanten(anything())).thenReturn(of(resultGeoJSONFeature));
        ...
        it('should invoke updateMappedGrundnetzkanten', () => {
          verify(manuellerImportService.updateMappedGrundnetzkanten(anything())).once();
          const command = capture(manuellerImportService.updateMappedGrundnetzkanten).last()[0];
      ...
      describe('deleteMappedGrundnetzkantenAtPositionOf', () => {
        ...
        describe('with feature without mappedGrundnetzkante', () => {
          ...
          it('should not deleteMappedGrundnetzkante', () => {
            verify(manuellerImportService.deleteMappedGrundnetzkanten(anything())).never();
            expect().nothing();
          });
        });
        ...
        describe('with feature with mappedGrundnetzkante', () => {
          beforeEach(
            waitForAsync(() => {
              ...
              when(manuellerImportService.deleteMappedGrundnetzkanten(anything())).thenReturn(
          ...
          it('should delete a mappedGrundnetzkante', () => {
            verify(manuellerImportService.deleteMappedGrundnetzkanten(anything())).once();
            const command = capture(manuellerImportService.deleteMappedGrundnetzkanten).last()[0];
