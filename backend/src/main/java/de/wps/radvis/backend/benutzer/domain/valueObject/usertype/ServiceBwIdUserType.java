...
public class ServiceBwIdUserType implements AttributeConverter<ServiceBwId, String> {
	...
	@Override
	public String convertToDatabaseColumn(ServiceBwId serviceBwId) {
		return serviceBwId == null ? null : serviceBwId.toString();
	}

	@Override
	public ServiceBwId convertToEntityAttribute(String dbData) {
		return dbData == null ? null : ServiceBwId.of(dbData);
	}
}
