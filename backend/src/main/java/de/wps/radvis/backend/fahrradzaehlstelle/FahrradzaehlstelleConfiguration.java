...
package de.wps.radvis.backend.fahrradzaehlstelle;
...
@EntityScan
public class FahrradzaehlstelleConfiguration {

	@Autowired
	private JobConfigurationProperties jobConfigurationProperties;

	@Autowired
	private FahrradzaehlstelleRepository fahrradzaehlstelleRepository;
	...
	@Bean
	public FahrradzaehlstellenMobiDataImportJob fahrradzaehlstellenMobiDataImportJob() {
		return new FahrradzaehlstellenMobiDataImportJob(jobExecutionDescriptionRepository, jobConfigurationProperties,
			fahrradzaehlstelleRepository, csvRepository, converter);
	}

	@Bean
	public FahrradzaehlstelleService fahrradzaehlstelleService() {
		return new FahrradzaehlstelleService(fahrradzaehlstelleRepository);
	}
}
